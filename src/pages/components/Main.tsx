    ...
    return(
        <>
           <div className="flex flex-col font-interstate-blackcondensed items-center ">
                <div className=" text-black-light font-bold text-[30px] mb-[0px] max-md:mb-[30px] sm:mb-[100px] mt-[30px] pt-[50px]">Designed for the future</div>
                <div className="flex max-md:flex-col relative max-md:items-center sm:self-start sm:h-[1000px] sm:min-h-[1000] sm:pl-[300px] sm:gap-[500px]   bg-editor-bg bg-no-repeat w-full bg-center bg-[900px_-50px] ">
                    <div className="sm:self-start sm:justify-self-cente mt-[150px] ">
                        <div className="font-interstate-blackcondensed ">
                            <Image className="hidden absolute order-3 left-[1000px] top-[-100px] min-h-882 min-w-925" src="/assets/images/illustration-editor-desktop.svg" alt="illustration" width={925} height={882} ></Image>
                ...
                <div className="flex max-md:flex-col h-[750px] sm:h-[500px] w-full rounded-bl-[100px] rounded-tr-[100px] bg-bg-purple overflow-hidden relative items-center justify-center sm:gap-[50px]  ">
                    <Image src={"/assets/images/bg-pattern-circles.svg"} width={600} height={600} alt="circles" className=" absolute max-md:top-[-190px] left-[270px] max-w-none z-0 "></Image>
                    <Image src={"/assets/images/illustration-phones.svg"} width={552} height={579} alt="phones" className=" z-20 sm:self-start overflow-visible"></Image>
                    <div className="z-10  max-md:text-center mt-[130px]">   
                ...
                <div className="sm:mt-[10px] flex flex-col items-center ">
                    <div className="font-interstate-blackcondensed mt-[10px]">
                    <h2 className="text-black-light font-bold text-[35px] text-center flex flex-col mb-[30px] "><span className="">Powerful tooling</span></h2>
                    <p className="text-center w-[300px] mt-[10px]"> 
